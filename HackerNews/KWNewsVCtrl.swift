...
class KWNewsVCtrl: UIViewController, UITableViewDataSource, UITableViewDelegate, SFSafariViewControllerDelegate {
  ...
  func configureUI() {
    refreshControl.addTarget(self, action: #selector(KWNewsVCtrl.retrieveStories), for: .valueChanged)
